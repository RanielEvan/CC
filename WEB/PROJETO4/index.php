...
<?php 
    ...
    $contador = intval($conteudoArquivo);
    $contador += 1;
...
<html>
    ...
    <body class="bg1 font2">

        <main>

            <div class="row" id="telaLogin">
                <div class="col-sm-4" style="display:block; margin:auto; margin-right: 86px; margin-top: 130px;  ">
            ...
            <div class="row" id="telaRegistro" style="display: none">
                <div class="col-sm-4" style="display:block; margin:auto; margin-right: 86px; margin-top: 60px;  ">
                    
                    <button type="button" style="float:right; padding: 5px 35px; margin-top:0.5rem" class="btn btn-info LoginBut">Fazer Login</button>
                    <h1 style="font-weight: bold">Registrar</h1>

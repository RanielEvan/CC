...
<html>
    <head>
        ...
        <!--Fonte-->
        <link href="https://fonts.googleapis.com/css?family=Coda|Russo+One&display=swap" rel="stylesheet">
    </head>


    <body class="bg2 font2">

        <main style="margin: 35 50;">

            <h2 style="font-weight: bold">Cadastro de Itens</h2>
            <div class="row" >

                <div class="col-sm-4"> 

                    <form id="produtoForm" action="addproduto.php" method="POST" style="margin-top: 0px">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label for="pEstoque">Imagem</label>
                                <!-- <input type="hidden" name="MAX_FILE_SIZE" value="9999999"/> -->
                                <input name="imagem" type="file"/>
                            </div>
                        </div>
                        
                        <button onclick="CadastrarProduto()" type="button" style="float:right; padding: 5px 35px; margin-top:30px" class="btn btn-success">Cadastrar Produto</button>
                    </form>
                    ...
                    <div id="listaProd" style="margin-top: 70px;"> 
                        ...
                        <table style="border: 2px outset; width:100%">
                            ...
                            <tbody style="padding:20px">
                                <?php 
                                    // echo $filtro;
                                    $dados = $con->query("SELECT * FROM produtos ORDER BY preco ".$filtro);
